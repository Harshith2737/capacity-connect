...
export default function Home() {
  ...
  const handleAssessmentStart = (assessmentId?: number, title = "Assessment") => {
    ...
    startAssessment.mutate({ assessmentId }, {
      onSuccess: (attempt) => toast.success("Attempt created", { description: `${title} · attempt ${attempt?.id ?? "created"} is now server-tracked.` }),
